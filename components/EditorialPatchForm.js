...
import { patchEditorial } from "../app/admin/editorial-patch/actions.js";
...
export default function EditorialPatchForm() {
  const [payload, setPayload] = useState("");
  const [fileError, setFileError] = useState("");
  const [state, formAction, pending] = useActionState(patchEditorial, null);
  ...
  return (
    <form action={formAction} className="border border-brand-border rounded-lg p-4 bg-white flex flex-col gap-3">
      ...
      <textarea
        ...
        placeholder='{"apple-iphone-duo": {"verdict": "...", "summary": "...", "pros": ["...", "..."], "cons": ["...", "..."]}, ...}'
