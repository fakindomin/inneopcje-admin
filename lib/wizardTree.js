...
export function resolvePath(answers) {
  ...
  if (marka === "tak") {
    ...
    // Full allowlist (lib/brands.js) has 19 telefony brands — way too many
    // one-tap options. Show only the top 2-3 by real recognition in Poland,
    // plus an escape hatch back toward "niszowa" for anyone whose brand
    // isn't in that short list, instead of dumping the whole allowlist.
