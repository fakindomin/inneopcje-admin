...
const RULES = [
  ...
  [/oled mla/i, 5], // LG's flagship OLED evo tech (Micro Lens Array, G-series) - same class as QD-OLED
  [/qd mini led/i, 5], // quantum-dot Mini-LED (e.g. Hisense/TCL flagships) - competes with OLED
  [/rgb mini led/i, 5], // RGB-backlit Mini-LED ("True RGB Mini LED" etc.) - newest flagship LCD tech

  // --- Tier 4: OLED, and the best LCD backlighting (full-array Mini-LED) ---
  [/oled/i, 4], // plain/WOLED (QD-OLED and OLED MLA already claimed above)
  ...
  // --- Tier 2: full-array local dimming without quantum dots ---
  [/full array led/i, 2],
